...
const herobtnLink = document.getElementById('herobtnLink')
const searchMore = document.getElementById('searchMore') 
const searchMoreLink = document.getElementById('searchMoreLink')
...
if(isLoggedIn === 'true' && loggedInUser){
    ...
    herobtnLink.href = '#property-con';
    searchMore.textContent = 'Search For More Properties...'
    searchMoreLink.href = '../pages/searchmore.html';
    bookNow.innerHTML = `
                Book now <i class="fa-solid fa-arrow-right fa-beat-fade" style="color: #2b1b12;"></i>
            `
    bookNowLink.href = '../pages/searchmore.html';
} else {
    heroBtn.textContent = 'Sign In';
...
function hotelCardDisplay (property){
    ...
    return `
        <div class="bg-[#DDC7BB] rounded-2xl overflow-hidden shadow-md transition-transform hover:scale-[1.02] duration-500">
                <img src= ${property.img.src || "assests/images/Group11.png"}   alt="" class="min-w-full">
                ...
                <div class="px-4 py-3 space-y-4">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex gap-2 items-center">
                            <div class="bg-[#FBF5F1] p-0.5 rounded-[5px]">
                                <img src="assests/icons/size.png" alt="" >
                            </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <p class="font-bold text-[#4F3527] text-sm">${property.prices.currency} ${property.prices.formattedAmount}</p>
                    </div>
                </div>
            </div>
    `
...
function showAllProperties (propertyArr) {
    ...
    if (propertyArr.length === 0 ){
        noPropertyDisplay.textContent = 'NO PROPERTY ALAYE'
        return
    }

    propertyContainer.innerHTML = propertyArr.slice(0.,3).map((property) => hotelCardDisplay(property)).join('')
